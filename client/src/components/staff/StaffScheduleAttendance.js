                    ...
                    <span
                      className={`text-xs font-semibold px-3 py-1 rounded-full ${
                        selectedDateLeave
                          ...
                          : selectedDateAttendance?.status === '근무중'
                          ? 'text-blue-600 bg-blue-50'
                          : selectedDateAttendance?.status === '출근'
                          ? 'text-green-600 bg-green-50'
                          : selectedDateAttendance?.status === '지각' ||
                            selectedDateAttendance?.status === '조퇴' ||
                            selectedDateAttendance?.status === '지각/조퇴' ||
                            selectedDateAttendance?.status === '결근'
