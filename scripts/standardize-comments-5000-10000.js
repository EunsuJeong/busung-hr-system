...
console.log('========================================');
console.log('  App.js 5000~10000줄 주석 완전 정리');
...
console.log('🔄 5000~10000줄 주석 처리 중...\n');

const START_LINE = 4999; // 0-indexed (5000번째 줄)
const END_LINE = Math.min(10000, lines.length);
let removeCount = 0;
