...
// MongoDB 연결
const MONGO_URI = process.env.MONGODB_URI || 'mongodb+srv://admin:pkmFyucLEwbn2j0T@BusungSteel.crpfhuw.mongodb.net/busung_hr';
...
mongoose.connect(MONGO_URI)
  .then(async () => {
    ...
    try {
      ...
      // Payroll 컬렉션 인덱스
      await db.collection('payrolls').createIndex({ employeeId: 1, year: -1, month: -1 });
      ...
      await db.collection('notifications').createIndex({ employeeId: 1, createdAt: -1 });
